...
public class ScanResult {
    ...
    public boolean getIsOsc() { return mIsOsc; }

    public int getWifiState() {return mWifiState;}

    public boolean getIsFactory() {return mIsFactory;}
    ...
    public boolean equals(Object o) {
        ...
        if (!mDeviceName.equals(scanResult.mDeviceName)) { return false; }
        if (!mBleAddress.equals(scanResult.mBleAddress)) { return false; }
        if (!mSerial.equals(scanResult.mSerial)) { return false; }
        if (mWifiState != scanResult.mWifiState) { return false; }
